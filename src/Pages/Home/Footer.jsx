  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        <div>
          <img src="./img/logo.png" width="200px" alt="Logoipsum" />
        </div>
      ...
      <div className="footer--content--container">
        <p className="footer--content"> <a href="https://www.linkedin.com/in/ganesh-gite-ab5b0b251/" > Made with 💖 by  Ganesh Gite  </a> </p>
        <div className="footer--social--icon">
          <ul>
            <li>
              <Link
